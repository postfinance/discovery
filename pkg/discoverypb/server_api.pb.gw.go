...
var (
	pattern_ServerAPI_RegisterServer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "servers"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ServerAPI_UnregisterServer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "servers", "name"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ServerAPI_ListServer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "servers"}, "", runtime.AssumeColonVerbOpt(true)))
)
